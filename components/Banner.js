      ...
      <div className='pb-8'>
        <section className="bg-gray-200 pt-6"> 
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 ">
                ...
                <h1 className="mb-4 text-3xl font-extrabold tracking-tight leading-none text-slate-700 md:text-5xl lg:text-7xl dark:text-white pl-10 pr-10 pt-7"> <span className='text-blue-500'>{titlePart1}</span> {titlePart2}</h1>
                ...
                {showButtons && (
                    <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                        {showLeftButton && (
                            <BannerActionLink href={buttonLeftUrl} className="inline-flex border border-blue-500 justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-blue/80 hover:bg-blue/80 focus:ring-4 focus:bg-blue-500 ">
                                {buttonLeft}
                                <svg className="ml-2 -mr-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
                            </BannerActionLink>
                        )}
                        {showRightButton && (
                            <BannerActionLink href={buttonRightUrl} className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-blue-500 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 border-gray-700 hover: bg-white ">
